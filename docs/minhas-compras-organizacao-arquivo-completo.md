# Minhas compras - organizacao das tabelas

Alterado somente o componente PHP compartilhado entre a pagina inicial e os resultados AJAX. Produto mostra quantidade e nome; a nova coluna Vendido por lista cada vendedor uma vez; recebimento e resumido por pedido. Confirmacoes de itens despachados continuam disponiveis. Historico mantem suas quatro colunas. Nenhuma alteracao de banco, CSS, busca, filtros, total, quantidades ou valores.

Validacao: sintaxe PHP, 135 renderizacoes com compras reais e conferencia de TRX-0049.
